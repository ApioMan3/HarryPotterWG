...
const container = document.getElementById('records-container');
  ...
  if (recordsArray.length === 0) {
    container.innerHTML = '<div class="message">No se han registrado juegos, complete el desafio para ver la tabla de resultados.</div>';
  } else {
    ...
    const headers = ['Posición','IP', 'Jugador', 'Correo', 'Casa', 'Intentos', 'Tiempo', 'Puntos','Fecha'];
